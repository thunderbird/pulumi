...
class AlbTargetGroupAlarmGroup(tb_pulumi.monitoring.AlarmGroup):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # populate when you make the .get() call for the resource. This and the dependency on a chain of Outputs whose
        # values are not guaranteed to be available at the time these statements are called necessitates this nested
        # function call stuff.
