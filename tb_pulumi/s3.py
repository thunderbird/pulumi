...
class S3Bucket(tb_pulumi.ThunderbirdComponentResource):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        encryption_config = aws.s3.BucketServerSideEncryptionConfigurationV2(
        ...
        ) if enable_server_side_encryption else None

        versioning_config = aws.s3.BucketVersioningV2(
